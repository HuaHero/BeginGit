...
if test -f ${DESTDIR}/usr/local/apache/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/usr/local/apache/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/usr/local/apache/bin/apu-1-config
else
